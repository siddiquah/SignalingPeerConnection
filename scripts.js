const userName = "Appi-"+Math.floor(Math.random() * 100000)
const password = "x";
document.querySelector('#user-name').innerHTML = userName;

const socket = io.connect('https://192.168.0.233:8181/',{
    auth: {
        userName,password
    }
})
...
// 192.168.0.153 - Local IP address
// 122.172.73.126 - public IP address
// 192.168.0.153 - Local IP address
// 192.168.0.153 - Local IP address